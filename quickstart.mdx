...
description: "Clone Dev Mode Arcade, install dependencies, start the Vite dev server, and personalise the portfolio by editing a single data file — all in under five minutes."
---
...
<Note>
  The exports use short aliases for bundle size (`p`, `s`, `a`, `c`, `g`). When you import from `data/mockData.js` in a component, use those short names: `import { p as projects, s as skills } from '../data/mockData.js'`.
</Note>
